class ColumnFilter
  ...
  PLAYER_PROPERTY_NAMES = [:first_name, :number, :position_id, :skill_move, :is_right_dominant, :both_feet_level,
                           :height, :weight, :birth_year, :nation_id, :overall, :market_value, :wage, :age_add_inj, :note]
  ...
  COLUMN_NAMES_TO_DISPLAY = %w(name first_name number position_id birth_year height weight
            nation_id is_right_dominant both_feet_level skill_move overall market_value wage age_add_inj)
